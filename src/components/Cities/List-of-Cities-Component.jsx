...
const List_of_cities = () => {
  return (
    <div className="flex flex-col items-center p-4">
      <h1 className="mb-4 text-2xl font-bold text-green-700">Mole Busters proudly serves the following cities</h1>
      <div className="text-center">
        <h2 className="mb-2 text-xl font-semibold text-green-700">Alameda County</h2>
        <p>
      ...
      <div className="mt-4 text-center">
        <h2 className="mb-2 text-xl font-semibold text-green-700">Contra Costa County</h2>
        <p>
      ...
      <div className="mt-4 text-center">
        <h2 className="mb-2 text-xl font-semibold text-green-700">Marin County</h2>
        <p>
      ...
      <div className="mt-4 text-center">
        <h2 className="mb-2 text-xl font-semibold text-green-700">Napa County</h2>
        <p>American Canyon, Calistoga, Napa, St. Helena, Yountville</p>
      </div>
      <div className="mt-4 text-center">
        <h2 className="mb-2 text-xl font-semibold text-green-700">San Francisco County</h2>
        <p>San Francisco</p>
      </div>
      <div className="mt-4 text-center">
        <h2 className="mb-2 text-xl font-semibold text-green-700">San Mateo County</h2>
        <p>
      ...
      <div className="mt-4 text-center">
        <h2 className="mb-2 text-xl font-semibold text-green-700">Santa Clara County</h2>
        <p>
      ...
      <div className="mt-4 text-center">
        <h2 className="mb-2 text-xl font-semibold text-green-700">Solano County</h2>
        <p>
          Benicia, Dixon, Fairfield, Rio Vista, Suisun City, Vacaville, Vallejo
        </p>
      </div>
      <div className="mt-4 text-center">
        <h2 className="mb-2 text-xl font-semibold text-green-700">Sonoma County</h2>
        <p>
