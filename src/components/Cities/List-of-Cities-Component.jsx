const List_of_cities = () => {
  return (
    <section className="flex flex-col items-center p-4">
      <h className="mb-4 text-xl md:text-3xl  font-bold text-green-700 text-center">Mole Busters Proudly Services the Following Cities:</h>
      <div className="text-center">
        <h1 className="mb-2 text-lg md:text-2xl font-semibold text-green-700">Alameda County</h1>
        <p>
      ...
      <div className="mt-4 text-center">
        <h1 className="mb-2 text-lg md:text-2xl font-semibold text-green-700">Contra Costa County</h1>
        <p>
      ...
      <div className="mt-4 text-center">
        <h1 className="mb-2 text-lg md:text-2xl font-semibold text-green-700">Marin County</h1>
        <p>
      ...
      <div className="mt-4 text-center">
        <h1 className="mb-2 text-lg md:text-2xl font-semibold text-green-700">Napa County</h1>
        <p>American Canyon, Calistoga, Napa, St. Helena, Yountville</p>
      </div>
      <div className="mt-4 text-center">
        <h1 className="mb-2 text-lg md:text-2xl font-semibold text-green-700">San Francisco County</h1>
        <p>San Francisco</p>
      </div>
      <div className="mt-4 text-center">
        <h1 className="mb-2 text-lg md:text-2xl font-semibold text-green-700">San Mateo County</h1>
        <p>
      ...
      <div className="mt-4 text-center">
        <h1 className="mb-2 text-lg md:text-2xl font-semibold text-green-700">Santa Clara County</h1>
        <p>
      ...
      <div className="mt-4 text-center">
        <h1 className="mb-2 text-lg md:text-2xl font-semibold text-green-700">Solano County</h1>
        <p>
          Benicia, Dixon, Fairfield, Rio Vista, Suisun City, Vacaville, Vallejo
        </p>
      </div>
      <div className="mt-4 text-center">
        <h1 className="mb-2 text-lg md:text-2xl font-semibold text-green-700">Sonoma County</h1>
        <p>
